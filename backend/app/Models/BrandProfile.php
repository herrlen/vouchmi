...
class BrandProfile extends Model {
    use HasUuids;
    protected $fillable = ['user_id','brand_name','brand_slug','company_email','description','logo_url','cover_url','website_url','industry','is_verified','subscription_plan','subscription_expires_at','stripe_customer_id','paypal_subscription_id','paypal_status','subscription_started_at'];
