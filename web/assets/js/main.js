...
const TRANSLATIONS = {
  de: {
    ...
    'benefits.brand.list4': 'Nur 1,99 € / Monat — kein Setup, keine Gebühren',
    ...
    'pricing.title': 'Einfache, faire <span class="accent">Preise.</span>',
    'pricing.sub': 'Vouchmi ist für User kostenlos. Influencer und Brands schalten mit einem kleinen Abo ihre vollen Features frei.',
    ...
    'price.influencer.amount': '0,99',
    'price.influencer.period': 'pro Monat · jederzeit kündbar · per PayPal',
    'price.influencer.f1': 'Verifiziertes Creator-Profil',
    'price.influencer.f2': 'Analytics-Dashboard',
    'price.influencer.f3': 'Brands direkt anschreiben',
    'price.influencer.f4': 'Sichtbarkeit für Brands erhöht',
    'price.influencer.f5': 'Creator-Badge im Profil',
    'price.influencer.cta': 'Als Influencer starten',

    'price.brand.tier': 'Brand',
    'price.brand.amount': '1,99',
  ...
  en: {
    ...
    'benefits.brand.list4': 'Just €1.99 / month — no setup, no fees',
    ...
    'pricing.title': 'Simple, fair <span class="accent">pricing.</span>',
    'pricing.sub': 'Vouchmi is free for users. Influencers and brands unlock full features with a small subscription.',
    ...
    'price.influencer.tier': 'Influencer',
    'price.influencer.amount': '0.99',
    'price.influencer.period': 'per month · cancel anytime · via PayPal',
    'price.influencer.f1': 'Verified creator profile',
    'price.influencer.f2': 'Analytics dashboard',
    'price.influencer.f3': 'Message brands directly',
    'price.influencer.f4': 'Increased visibility for brands',
    'price.influencer.f5': 'Creator badge on profile',
