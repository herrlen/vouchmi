...
const TRANSLATIONS = {
  de: {
    ...
    'benefits.brand.list4': 'Reichweite gezielt boosten — zahl nur was du nutzt',
    ...
    'pricing.title': 'Du zahlst nur die <span class="accent">Reichweite</span>, die du brauchst.',
    'pricing.sub': 'Vouchmi ist für alle kostenlos. Wer mehr Reichweite will, lädt Credits auf und bewirbt einzelne Empfehlungen — keine Abos, kein Setup.',
    'pricing.disclaimer': 'Credits sind 3 Jahre gültig. Geboostete Empfehlungen werden gemäß §6 TMG / DSA mit „Beworben" gekennzeichnet. Bei Apple- oder PayPal-Refund werden Credits automatisch zurückgebucht.',

    'price.user.tier': 'Kostenlos',
    'price.user.amount': '0',
    'price.user.period': 'für alle, für immer',
    'price.user.f1': 'Unbegrenzt Empfehlungen posten & entdecken',
    'price.user.f2': 'Communities beitreten',
    'price.user.f3': 'Eigene Sammlung & Profil',
    'price.user.f4': 'Influencer & Brands direkt anschreiben',
    'price.user.f5': 'Analytics für eigene Inhalte',
    'price.user.cta': 'App laden',

    'price.boost.tier': 'Boost',
    'price.boost.amount': 'ab 4,99',
    'price.boost.period': 'Credit-Pakete · PayPal oder Apple · keine Vertragsbindung',
    'price.boost.f1': '500 Credits ab 4,99 € · bis 15.000 Credits',
    'price.boost.f2': 'Mini-Boost: ×2 Reichweite, 6 Std., 50 Credits',
    'price.boost.f3': 'Standard: ×3 Reichweite, 24 Std., 150 Credits',
    'price.boost.f4': 'Pro: ×5 Reichweite + Discover-Slot, 72 Std., 400 Credits',
    'price.boost.f5': 'Brand-Push: ×8 Reichweite + Push, 7 Tage, 1.000 Credits',
    'price.boost.cta': 'Jetzt starten',

    'faq.eyebrow': 'FAQ',
    'faq.title': 'Häufige Fragen <span class="accent">zu Credits.</span>',
    'faq.q1': 'Was sind Credits und wofür brauche ich sie?',
    'faq.a1': 'Credits sind Vouchmi-Guthaben, mit dem du einzelne Empfehlungen bewerben kannst. Ein Boost erhöht die Reichweite eines Posts für eine bestimmte Zeit. Vouchmi selbst nutzen ist und bleibt komplett kostenlos.',
    'faq.q2': 'Wie viel kosten Credits?',
    'faq.a2': 'Wir bieten vier Pakete: 500 Credits für 4,99 €, 1.500 für 12,99 €, 5.000 für 39,99 € und 15.000 für 99,99 €. Je größer das Paket, desto besser der Credit-Preis.',
    'faq.q3': 'Wie wird gezahlt?',
    'faq.a3': 'Auf iPhone und iPad läuft die Zahlung über deinen App-Store-Account (Apple In-App-Purchase). Auf Android und über das Web-Portal bezahlst du sicher mit PayPal. Andere Wege sind aktuell nicht vorgesehen.',
    'faq.q4': 'Verfallen meine Credits?',
    'faq.a4': 'Nicht so schnell. Credits sind gesetzlich 3 Jahre ab Kauf gültig — also reichlich Zeit, sie sinnvoll einzusetzen.',
    'faq.q5': 'Kann ich gekaufte Credits zurückgeben?',
    'faq.a5': 'Digitale Leistungen wie Credits sind nach dem Kauf grundsätzlich vom Widerrufsrecht ausgeschlossen, sobald sie auf deinem Konto gutgeschrieben sind. Bei Fehlbuchungen oder doppelten Abbuchungen melde dich beim Support — wir klären das. Erstattet Apple oder PayPal eine Zahlung, buchen wir die Credits automatisch zurück.',
    'faq.q6': 'Wie wird ein Boost angezeigt?',
    'faq.a6': 'Geboostete Empfehlungen werden gemäß §6 TMG und Digital Services Act mit „Beworben" gekennzeichnet — transparent und für alle sichtbar. Es gibt kein Verstecken bezahlter Reichweite.',
    'faq.q7': 'Sind Steuern bereits enthalten?',
    'faq.a7': 'Ja, alle Preise sind Endpreise inklusive der gesetzlichen Mehrwertsteuer.',
    'faq.q8': 'Was ist mit bestehenden Abos?',
    'faq.a8': 'Bestehende Influencer- und Brand-Abos laufen wie vereinbart aus. Wir rechnen die Restlaufzeit anteilig in Credits um und schreiben dir 20 % Goodwill-Bonus on top gut — automatisch, ohne dass du etwas tun musst.',
  ...
  en: {
    ...
    'benefits.brand.list4': 'Boost reach when you need it — pay only for what you use',
    ...
    'pricing.title': 'Pay only for the <span class="accent">reach</span> you need.',
    'pricing.sub': 'Vouchmi is free for everyone. Want more reach? Top up credits and boost individual recommendations — no subscription, no setup.',
    'pricing.disclaimer': 'Credits are valid for 3 years. Boosted recommendations are labelled "Sponsored" per the Digital Services Act. If Apple or PayPal refunds a payment, credits are clawed back automatically.',

    'price.user.tier': 'Free',
    'price.user.amount': '0',
    'price.user.period': 'for everyone, forever',
    'price.user.f1': 'Unlimited recommendations',
    'price.user.f2': 'Join communities',
    'price.user.f3': 'Personal collection & profile',
    'price.user.f4': 'Message influencers and brands directly',
    'price.user.f5': 'Analytics for your own content',
    'price.user.cta': 'Get the app',

    'price.boost.tier': 'Boost',
    'price.boost.amount': 'from 4.99',
    'price.boost.period': 'Credit packs · PayPal or Apple · no contract',
    'price.boost.f1': '500 credits from €4.99 · up to 15,000 credits',
    'price.boost.f2': 'Mini boost: ×2 reach, 6 h, 50 credits',
    'price.boost.f3': 'Standard: ×3 reach, 24 h, 150 credits',
    'price.boost.f4': 'Pro: ×5 reach + Discover slot, 72 h, 400 credits',
    'price.boost.f5': 'Brand push: ×8 reach + push, 7 days, 1,000 credits',
    'price.boost.cta': 'Get started',

    'faq.eyebrow': 'FAQ',
    'faq.title': 'Frequently asked <span class="accent">about credits.</span>',
    'faq.q1': 'What are credits and what are they for?',
    'faq.a1': 'Credits are Vouchmi balance you spend to boost individual recommendations. A boost increases a post’s reach for a set duration. Using Vouchmi itself stays completely free.',
    'faq.q2': 'How much do credits cost?',
    'faq.a2': 'Four packs: 500 credits for €4.99, 1,500 for €12.99, 5,000 for €39.99, 15,000 for €99.99. The larger the pack, the better the per-credit price.',
    'faq.q3': 'How do I pay?',
    'faq.a3': 'On iPhone and iPad, payments run via your App Store account (Apple in-app purchase). On Android and the web portal you pay securely via PayPal. No other payment methods today.',
    'faq.q4': 'Do my credits expire?',
    'faq.a4': 'Not for a long while. Credits are valid for 3 years from purchase under German law — plenty of time to put them to use.',
    'faq.q5': 'Can I get a refund on purchased credits?',
    'faq.a5': 'Digital goods like credits are excluded from withdrawal rights once they’re posted to your account. For mistaken or duplicate charges, contact support. If Apple or PayPal refunds a payment, we’ll claw the credits back automatically.',
    'faq.q6': 'How is a boosted post marked?',
    'faq.a6': 'Boosted recommendations are labelled "Sponsored" per §6 TMG and the Digital Services Act — fully transparent. We never hide paid reach.',
    'faq.q7': 'Are taxes included?',
    'faq.a7': 'Yes. All prices shown are final, including the legally required VAT.',
    'faq.q8': 'What about my existing subscription?',
    'faq.a8': 'Existing influencer and brand subscriptions run out as agreed. We convert the remaining time pro-rata into credits and add a 20% goodwill bonus on top — automatically, nothing you need to do.',
